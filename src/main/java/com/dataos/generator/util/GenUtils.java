package com.dataos.generator.util;

import com.dataos.generator.domain.ColumnDO;
import com.dataos.generator.domain.TableDO;
import com.dataos.generator.exception.BDException;
...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        map.put("datetime", DateUtils.format(new Date(), DateUtils.DATE_FORMAT_DATETIME));
